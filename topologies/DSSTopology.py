...
def sgsim_startcom_104(self, line):
    ...
    net.get('DSS1RTU').cmdPrint('xterm -geometry 90x30+10+10 -fa "Monospace" -fs 12 -T "DSS1RTU" -e "cd /home/sgsim/SmartGridSim/comlib_dss/sgdevices/RTU/;./rtu 1.1.1.1;bash"&') 
    time.sleep(0.5)
    info('Starting DSS2RTU communication... \n')    
    net.get('DSS2RTU').cmdPrint('xterm -geometry 90x30+30+30 -fa "Monospace" -fs 12 -T "DSS2RTU" -e "cd /home/sgsim/SmartGridSim/comlib_dss/sgdevices/RTU/;./rtu 1.1.2.1;bash"&') 
    time.sleep(0.5)
