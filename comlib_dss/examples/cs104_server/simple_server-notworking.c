...
interrogationHandler(void* parameter, IMasterConnection connection, CS101_ASDU asdu, uint8_t qoi)
{
    ...
    if (qoi == 20) { /* only handle station interrogation */
        ...
        InformationObject io2 = (InformationObject) ParameterFloatValue_create(NULL, 100, 29.25, IEC60870_QUALITY_GOOD);

        CS101_ASDU_addInformationObject(newAsdu, io2);

        CS101_ASDU_addInformationObject(newAsdu, (InformationObject)
            ParameterFloatValue_create((ParameterFloatValue) io2, 101, 23, IEC60870_QUALITY_GOOD));
        ...
        io2 = (InformationObject) ParameterFloatValue_create(NULL, 104, 29.25, IEC60870_QUALITY_GOOD);

        CS101_ASDU_addInformationObject(newAsdu, io);

        CS101_ASDU_addInformationObject(newAsdu, (InformationObject)
	      ParameterFloatValue_create((ParameterFloatValue) io2, 105, 29.25, IEC60870_QUALITY_GOOD));
